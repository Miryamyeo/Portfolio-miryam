...
const projects = [
  ...
  },
  {
    ...
    demoUrl: "portfolio-miryam-mauve.vercel.app/",
  },
  {
    name: "YOWL",
    image: "YOWL.jpeg",
 ...
 {
  name: "AVEA (allez vivre en afrique)",
  image: "AVEA.png",
  type: "Site Web",
  year: "2026",
  desc: "Site web moderne conçu pour présenter les activités, projets et initiatives d’AVEA.",
  tags: ["WordPress", "Elementor", "Web Design"],
  demoUrl: "https://allervivreenafrique.com/",
},
   {
    name: "EventPlace",
    image: "/evens.png",
    type: "Application Web",
    year: "2026   ",
    desc: "Site de reservation de concert.",
    tags: ["React", "Chart.js", "API"],
    demoUrl: "https://my-show-time-essr.onrender.com/",
  },
  {
    name: "DOMINA",
    image: "/image.png",
